...
const Article = () => {
  ...
  return (
    <div className="Article">
      ...
      <ArticleCard image={Blog1} heading={articleHeading[0].heading} para={articleHeading[0].para}/>
      <ArticleCard image={Blog2}  heading={articleHeading[1].heading} para={articleHeading[1].para} />
      <ArticleCard image={Blog3}  heading={articleHeading[2].heading} para={articleHeading[2].para} />
